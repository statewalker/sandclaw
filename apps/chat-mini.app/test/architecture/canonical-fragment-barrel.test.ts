 ...
 * `../../../../../<package-dir>/` for `@statewalker/chat-mini.*` packages or
...
const CHAT_LOGIC_PACKAGES = [
  { npmName: "@statewalker/chat-mini.chat", dir: "chat-mini.chat" },
];
const CHAT_REACT_PACKAGES = [
  { npmName: "@statewalker/chat-mini.chat-react", dir: "chat-mini.chat-react" },
];
